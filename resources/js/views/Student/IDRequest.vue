    ...
    <div>
        ...
        >
            ...
            <div class="col-5 shadow p-3 px-4 pt-3 mx-2">
                ...
                <div class="row px-4">
                    <div
                        class="col-12 pl-2 border-top py-2"
            ...
            >
                <div class="text-center">
                    ...
                    <span
                        >Note. You can cancel this action an check your
                        information.</span
                    >
                </div>
            </b-modal>
...
export default {
    ...
    methods: {
        ...
        setIdInfo() {
            this.id_info = {
                ...
                address:
                    this.user[0].student.student_basic_info.current_address,
                ...
                mobile_no:
                    this.user[0].student.student_basic_info.mobile_number,
                telephone_no:
                    this.user[0].student.student_basic_info.telephone_number,
                image: this.user[0].student.id_image,
                signature: this.user[0].student.signature,
            };

            this.student_id = this.user[0].student.id;
        },
    },
    computed: {
        user() {
    ...
    async mounted() {
        await this.$store.dispatch(
            "STUDENT_ID_REQUEST/FETCH_REQUEST_LOGS",
            this.user[0].student.id
        );
        this.setIdInfo();
        // //
        // console.log(this.user[0].student.student_basic_info.first_name);
    },
};
</script>
