            ...
            <div class="d-flex mt-5">
                <div class="col-12 col-lg-12">
                    <div class="bg-light card shadow-sm">
                        ...
                        <div class="col-12">
                            <h5 class="ms-5">
                                Overall Alumni Summary by Batch
                            </h5>
    ...
    computed: {
        alumni_records_count() {
            return this.$store.getters[
                "ADMIN_DASHBOARD/GET_ALUMNI_RECORD_COUNT"
            ];
        },
        alumni_application_count() {
            return this.$store.getters[
        ...
        alumni_id_records_count() {
            return this.$store.getters[
                "ADMIN_DASHBOARD/GET_ALUMNI_ID_RECORDS_COUNT"
            ];
        },
        alumni_by_batch() {
            return [];
