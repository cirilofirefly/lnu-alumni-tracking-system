				...
				<table class="table table-striped mt-4">
					...
					<tbody>
						...
						<tr v-else v-for="alumni in alumnae" :key="alumni.id">
							...
							<td class="text-center">
								<button v-if="alumni.status == 1" @click="$router.push({ path: `id-printable/${alumni.id}`})" class="btn btn-primary">
									Preview
								</button>
								<button
							...
							<div class="row">
								<div class="col-12">
									...
									<input
										...
										type="text"
										class="form-control"
										v-model="alumni.alumni_info.student_number"
									/>
								</div>
								<div class="col-12">
								...
								<div class="col-12">
									...
									<input
										...
										type="text"
										class="form-control"
										v-model="alumni.alumni_info.telephone_no"
									/>
								</div>
							</div>
						</div>
...
export default {
	...
	computed: {
		alumnae() {
			return this.$store.getters["ADMIN_ID_MANAGEMENT/GET_STUDENT_ID_REQUESTS"];
		},
	},
	methods: {
