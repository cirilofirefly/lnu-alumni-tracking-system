                ...
                <div class="row">
                    ...
                    <div class="col-9">
                        <div class="mt-2">
                            ...
                            <h6>
                                ...
                                <strong
                                    >{{
                                        alumni.student.student_basic_info.email
                                    }}
                                </strong>
                            </h6>
                            <h6>
                    ...
                    <div class="col-12 mt-3">
                        <h6>
                            ...
                            <strong
                                >{{
                                    alumni.student.student_basic_info.birthdate
                                        | setDate
                                }}
                            </strong>
                        </h6>
                        ...
                        <h6>
                            Gender:
                            <strong
                                >{{ alumni.student.student_basic_info.gender }}
                            </strong>
                        </h6>
                        <h6>
                            Religion:
                            <strong
                                >{{
                                    alumni.student.student_basic_info.religion
                                }}
                            </strong>
                        </h6>
                        <h6>
