<template>
    <div class="container-fluid">
        <div class="row p-5">
            <div class="col-12">
                <h1 class="text-uppercase fw-bold">Event Management</h1>
            </div>
                ...
                <div>
                    <table class="table table-striped">
                        ...
                        <tbody>
                            <div
                                v-if="loading"
                                class="mt-2 float-center mx-auto"
                            >
...
export default {
    ...
    data() {
        return {
            sampletext:
                "sample text that the length is greater than 5 kape kape",
            id: null,
            eventInfo: {
                name: "",
                content: "",
